...
#main(['4_8.txt','e.txt'])
#main(['4_9_NE.txt','e.txt'])
#main(['50_80.txt','e.txt'])
#main(['300_883.txt','e.txt'])

## ni vredu
#main(['64_254.txt','e.txt']) # vrne ni rešitve
#main(['100_160_NE.txt','e.txt'])
#main(['600_1841.txt','e.txt'])
#main(['600_2237.txt','e.txt'])
#main(['1318_3668.txt','e.txt'])
